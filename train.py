...
def parser_args():
    parser = argparse.ArgumentParser(description='Intention Understanding Training')
    available_models = ['R101-448', 'R101-576', 'R50']
    parser.add_argument('--dataname', help='dataname', default='intentonomy', choices=['intentonomy'])
    parser.add_argument('--dataset_dir', help='dir of dataset', default='/data/sqhy_data/intent_resize/')
    ...
    parser.add_argument('--output', metavar='DIR', default='/data/sqhy_model/LabCR/Intentonomy/111/',
                        help='path to output folder')
    parser.add_argument('--num_class', default=28, type=int,
                        help="Number of query slots")  # intentonmy=28, PA100K=26,RAP=51，92
    parser.add_argument('--pretrained', dest='pretrained', action='store_true',
                        help='use pre-trained model. default is False. ')
    parser.add_argument('--optim', default='AdamW', type=str, choices=['AdamW', 'Adam_twd'],
                        help='which optim to use')
    parser.add_argument('-a', '--arch', metavar='ARCH', default='R101-448',
    ...
    parser.add_argument('--loss_clip', default=0.0, type=float,help='scale factor for clip')

    parser.add_argument('-j', '--workers', default=32, type=int, metavar='N',
                        help='number of data loading workers (default: 32)')
    parser.add_argument('--epochs', default=30, type=int, metavar='N',
                        help='number of total epochs to run')  # intentonomy=30，PA100K=50, RAP=
    ...
    parser.add_argument('-b', '--batch-size', default=64, type=int,
                        ...
                        help='mini-batch size (default: 256), this is the total '
                            'batch size of all GPUs') #intentonomy=64, pa100k=128,rap=128
