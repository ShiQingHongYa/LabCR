...
def eval_validation_set(
    ...
    # val_scores = np.random.rand(*val_scores.shape)   #  get the random value
    f1_dict = get_best_f1_scores(multihot_targets, val_scores)
...
def validate_f1(imagessetfilelist, num, return_each=False):
    ...
    f1_dict = eval_validation_set(scores, targets)
