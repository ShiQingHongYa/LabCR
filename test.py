...
def parser_args():
    parser = argparse.ArgumentParser(description='Intention Understanding Testing')
    ...
    parser.add_argument('--output', metavar='DIR',
                        default='/data/sqhy_model/LabCR/Intentonomy/111/test',
                        help='path to output folder')
    parser.add_argument('--resume',
                        default="/data/sqhy_model/LabCR/Intentonomy/111/model_best.pth.tar",
